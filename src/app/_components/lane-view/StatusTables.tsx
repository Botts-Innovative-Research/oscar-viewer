...
// import {
//     AlarmTableData,
//     AlarmTableDataCollection, EventTableData,
...
// import {addEventToLog} from "@/lib/state/EventDataSlice";
//
...
//         let gammaDS: typeof DataStream = laneEntry.findDataStreamByObsProperty("http://www.opengis.net/def/pillar-occupancy-count");
//         let tamperDS: typeof DataStream = laneEntry.findDataStreamByObsProperty("http://www.opengis.net/def/pillar-occupancy-count");
//         let neutronDS: typeof DataStream = laneEntry.findDataStreamByObsProperty("http://www.opengis.net/def/pillar-occupancy-count");
//
//         if (!occDS) {
//             return;
//         }
...
//     }
//
//     function TamperRTMsgHandler(laneName:string, message: any){
...
//                 TamperRTMsgHandler(laneName, message);
//             });
