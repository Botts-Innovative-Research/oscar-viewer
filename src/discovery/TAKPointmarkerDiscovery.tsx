...
// @ts-ignore
const Mil2525 = "./resources/mil-std-2525";


export async function discoverTAKPointmarkers(server: SensorHubServer, withCredentials: boolean): Promise<IObservable[]> {

    let observables: IObservable[] = [];

    await discover(server, withCredentials, "tak_point_marker")
        .then(discoveryData => {
            ...
            for (let result of resultSet) {
                ...
                let locationData = fetchFromObject(result, 'tak_point_marker');
                ...
                let pointMarkerLayer: PointMarkerLayer = new PointMarkerLayer({
                    ...
                    // icon: "/resources/mil-std-2525/".concat("sfgpuci--------",".svg"),
                    getIcon: {
                        // @ts-ignore
                        dataSourceIds: [locationDataSource.getId()],
                        handler: function (rec: any) {
                    ...
                    getName: {
                      ...
                      dataSourceIds:[locationDataSource.getId()],
                      handler: function (rec: any){
                          return findInObject(rec, 'description');
                      }
                    },
                    getLabel: {
                        // @ts-ignore
